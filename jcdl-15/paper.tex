...
Our approach has been to provide as much context as possible around the primary recordings  while still providing contributors flexibility that they have come to expect from their own, possibly \textit{ad hoc}, archival systems.
To keep datasets intact, Databrary incorporates allows heterogeneous flat-file data, materials, and references to be associated with the primary video or audio recordings.
...
%%dg - might move the last sentence around, but provides a gist.
