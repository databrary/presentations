...
This facilitates a depth of access to configure data more to the original context in which it was collected and analyzed.
% that use of "configure" doesn't make sense to me -dylan
...
We also allow for ``dumps'' using certain portable data formats to include any data that cannot be encompassed by our standard formats, reasoning that these data may be relevant for re-use, but not broadly adopted by the community.
