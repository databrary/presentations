...
This naturally reduces the problems of documentation and re-use that plague many flat-file datasets or repositories for data that require propietary software to view.
