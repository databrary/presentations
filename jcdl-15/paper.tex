...
The goal of the Databrary project is build tools and policies that simplify repurposing and reuse of recordings.
...
In short, recordings pose challenges that older, less dynamic media do not \cite{Lanagan_Smeaton_2012}.
