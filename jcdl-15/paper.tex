...
Recordings are often the core component of a data collection, and so sessions were designed to structure them in a way familiar to researchers.
Sessions provide raw materials for subsequent detailed analysis or documentation about what measurements were made during the collection \cite{Bakeman_2012}.
