...
\begin{abstract}
Video and audio recordings serve as a primary data source in many fields, especially in the social and behavioral sciences, and present unique opportunities for reuse and reanalysis for novel scientific purposes.
...
By investigating how researchers organize, analyze, and mine their own recording data, we have implemented a number of structural generalizations to capture these data and their context allowing standardization, sharing, and understanding.
