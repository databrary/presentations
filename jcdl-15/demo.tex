...
Recordings present unique opportunities for reuse and reanalysis for novel scientific purposes, but also present challenges due around respecting the privacy of individuals depicted.
...
Data originate from 35 individual contributors across 25 different universities. 50 universities have granted access to the repository to over 95 researchers.
...
As we continue to gather feedback from our user base, we not only see Databrary as a tool that facilitates the standardized management of research data, but also as an opportunity to enhance the ability for academics to communicate about and enhance their own research.
